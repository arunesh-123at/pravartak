...
import { getStudentsByMentor, StudentRecord } from './StudentData';
...
export function MentorDashboard({ onUpdateStudent }: MentorDashboardProps) {
  const { user, logout } = useAuth();
  const [students, setStudents] = useState<StudentRecord[]>(getStudentsByMentor(user?.id || 'mentor1'));
